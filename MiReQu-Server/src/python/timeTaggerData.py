...
class CoincidencesNoUI():
    ...
    def __init__(self,  tagger):
        ...
        self.defaultTimeTaggerParameters = {
            ...
            "testsignalA": False,
            "testsignalB": False,
            "coincidenceWindow": 1000,  # ps min=1 max=9999 TODO: Implement Check in class
...
class CoincidenceStream(QtWidgets.QMainWindow, Ui_CoincidenceStream):

    def __init__(self,  tagger):
        # Create the UI from the designer file and connect its action buttons
        super().__init__()
        self.ui = Ui_CoincidenceStream()
        ...
        self.defaultTimeTaggerParameters = {
            ...
            "testsignalA": False,
            "testsignalB": False,
            "coincidenceWindow": 8000,  # ps min=1 max=9999 TODO: Implement Check in class
            "correlationBinwidth": 40,  # ps min=1 max=9999 TODO: Implement Check in class
            "correlationBins": 1000,  # min=1 max=9999 TODO: Implement Check in class
        }
