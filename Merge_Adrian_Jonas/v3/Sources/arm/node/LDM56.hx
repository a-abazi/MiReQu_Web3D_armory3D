...
@:keep class LDM56 extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Object_003.addInput(new armory.logicnode.ObjectNode(this, "LDM56_BA2"), 0);
		...
		_TranslateObject.addInput(_Object_003, 0);
		...
		_GetLocation.addInput(_Object_003, 0);
		...
		_VectorMath.addInput(new armory.logicnode.VectorNode(this, 0.0, 0.0, 0.5755199790000916), 0);
		...
		_Integer.addInput(_MouseCoords_004, 2);
		var _Math_013 = new armory.logicnode.MathNode(this);
		_Math_013.property0 = "Multiply";
		_Math_013.property1 = "false";
		_Math_013.addInput(_Integer, 0);
		_Math_013.addInput(new armory.logicnode.FloatNode(this, 0.01570799946784973), 0);
		var _Vector_003 = new armory.logicnode.VectorNode(this);
		_Vector_003.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_003.addInput(_Math_013, 0);
		_Vector_003.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_003.addOutputs([_RotateObject]);
		_Math_013.addOutputs([_Vector_003]);
		_Integer.addOutputs([_Math_013]);
		_MouseCoords_004.addOutputs([_Integer]);
		...
		_RotateObject.addInput(_Object_003, 0);
		_RotateObject.addInput(_Vector_003, 0);
		_RotateObject.addOutputs([new armory.logicnode.NullNode(this)]);
		_Object_003.addOutputs([_Gate_004, _TranslateObject, _GetLocation, _SetLocation, _RotateObject, _Gate]);
		_SetLocation.addInput(_Object_003, 0);
		...
		_Object_006.addInput(new armory.logicnode.ObjectNode(this, "LDM56_UPH2_02_Screw"), 0);
		...
		_Object_004.addInput(new armory.logicnode.ObjectNode(this, "LDM56_UPH2_01_Screw"), 0);
		_Object_004.addOutputs([_SetTransform, _Gate_007]);
		_SetTransform.addInput(_Object_004, 0);
		var _GetTransform = new armory.logicnode.GetTransformNode(this);
		_GetTransform.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56_UPH2_01_Screw"), 0);
		...
		var _Object_007 = new armory.logicnode.ObjectNode(this);
		_Object_007.addInput(new armory.logicnode.ObjectNode(this, "LDM56"), 0);
		_Object_007.addOutputs([_SetTransform_002]);
		_SetTransform_002.addInput(_Object_007, 0);
		var _GetTransform_002 = new armory.logicnode.GetTransformNode(this);
		_GetTransform_002.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56"), 0);
		...
		_OnUpdate_001.addOutputs([_SetTransform, _SetTransform_001, _SetTransform_002]);
		_SetTransform_001.addInput(_OnUpdate_001, 0);
		_SetTransform_001.addInput(_Object_006, 0);
		var _GetTransform_001 = new armory.logicnode.GetTransformNode(this);
		_GetTransform_001.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56_UPH2_02_Screw"), 0);
		...
		_Object_006.addOutputs([_SetTransform_001, _Gate_005]);
		_Gate_005.addInput(_Object_006, 0);
		...
		_RotateObject_001.addInput(_Merge, 0);
		_RotateObject_001.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56_UPH2_01_Screw"), 0);
		...
		_RotateObject_002.addInput(_Merge, 0);
		_RotateObject_002.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56_UPH2_02_Screw"), 0);
		_RotateObject_002.addInput(_Vector_002, 0);
		_RotateObject_002.addOutputs([new armory.logicnode.NullNode(this)]);
		_Vector_002.addOutputs([_RotateObject_001, _RotateObject_002]);
		...
		_PickObject_002.addOutputs([_Gate_005, _Gate_007]);
		_PickObject_002.addOutputs([new armory.logicnode.VectorNode(this, 0.0, 0.0, 0.0)]);
		_Gate_005.addInput(_PickObject_002, 0);
		_Gate_005.addOutputs([_Merge]);
		_OnUpdate.addOutputs([_Gate_005, _Gate_007]);
		_Gate_007.addInput(_OnUpdate, 0);
		_Gate_007.addInput(_Object_004, 0);
		_Gate_007.addInput(_PickObject_002, 0);
		_Gate_007.addOutputs([_Merge]);
		_Merge.addInput(_Gate_007, 0);
		_Merge.addInput(_Gate_005, 0);
		_Merge.addOutputs([_RotateObject_002, _RotateObject_001, _TranslateObject_002]);
		_TranslateObject_002.addInput(_Merge, 0);
		_TranslateObject_002.addInput(new armory.logicnode.ObjectNode(this, "Ur_LDM56"), 0);
