...
@:keep class KM100 extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Object_004.addInput(new armory.logicnode.ObjectNode(this, "KM100_Base"), 0);
		var _Object_006 = new armory.logicnode.ObjectNode(this);
		_Object_006.addInput(_Object_004, 0);
		...
		_OnUpdate_002.addOutputs([_Gate]);
		_Gate.addInput(_OnUpdate_002, 0);
		_Gate.addInput(_Object_006, 0);
		...
		_RotateObject.addInput(_Gate, 0);
		_RotateObject.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Base.003"), 0);
		...
		_PickObject_004.addOutputs([_Gate]);
		_PickObject_004.addOutputs([new armory.logicnode.VectorNode(this, 0.0, 0.0, 0.0)]);
		_Gate.addInput(_PickObject_004, 0);
		_Gate.addOutputs([_RotateObject]);
		_Gate.addOutputs([new armory.logicnode.NullNode(this)]);
		_Object_006.addOutputs([_Gate]);
		_Object_004.addOutputs([_SetTransform_001, _Object_006]);
		_SetTransform_001.addInput(_Object_004, 0);
		var _GetTransform_001 = new armory.logicnode.GetTransformNode(this);
		_GetTransform_001.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Base.003"), 0);
		...
		_Object_005.addInput(new armory.logicnode.ObjectNode(this, "KM100_Screw_Side"), 0);
		...
		_Gate_005.addInput(_Object_005, 0);
		...
		_RotateObject_001.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Side.003"), 0);
		...
		_Math_007.addInput(new armory.logicnode.FloatNode(this, 0.05000000074505806), 0);
		...
		_TranslateObject_001.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Side.003"), 0);
		...
		_Math_001.addInput(_MouseCoords_002, 2);
		_Math_001.addInput(new armory.logicnode.FloatNode(this, -0.0013000000035390258), 0);
		...
		_RotateObject_003.addInput(_Gate_005, 0);
		_RotateObject_003.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Kugellager.003"), 0);
		...
		_MouseCoords_002.addOutputs([_Math, _Math_007, _Math_001]);
		...
		_Gate_005.addOutputs([_TranslateObject_001, _RotateObject_001, _RotateObject_003]);
		_Object_005.addOutputs([_SetTransform_002, _Gate_005]);
		_SetTransform_002.addInput(_Object_005, 0);
		var _GetTransform_002 = new armory.logicnode.GetTransformNode(this);
		_GetTransform_002.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Side.003"), 0);
		...
		_Object.addInput(new armory.logicnode.ObjectNode(this, "KM100_Screw_Up"), 0);
		...
		_Math_002.addInput(_MouseCoords_003, 2);
		_Math_002.addInput(new armory.logicnode.FloatNode(this, 0.10000000149011612), 0);
		var _Vector_005 = new armory.logicnode.VectorNode(this);
		_Vector_005.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_005.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_005.addInput(_Math_002, 0);
		var _RotateObject_005 = new armory.logicnode.RotateObjectNode(this);
		_RotateObject_005.addInput(_Gate_007, 0);
		_RotateObject_005.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Up.003"), 0);
		_RotateObject_005.addInput(_Vector_005, 0);
		_RotateObject_005.addOutputs([new armory.logicnode.NullNode(this)]);
		_Vector_005.addOutputs([_RotateObject_005]);
		_Math_002.addOutputs([_Vector_005]);
		var _Math_008 = new armory.logicnode.MathNode(this);
		_Math_008.property0 = "Multiply";
		_Math_008.property1 = "false";
		_Math_008.addInput(_MouseCoords_003, 2);
		_Math_008.addInput(new armory.logicnode.FloatNode(this, 0.05000000074505806), 0);
		var _Vector_007 = new armory.logicnode.VectorNode(this);
		_Vector_007.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_007.addInput(new armory.logicnode.FloatNode(this, 0.0), 0);
		_Vector_007.addInput(_Math_008, 0);
		var _TranslateObject_002 = new armory.logicnode.TranslateObjectNode(this);
		_TranslateObject_002.addInput(_Gate_007, 0);
		_TranslateObject_002.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Up.003"), 0);
		_TranslateObject_002.addInput(_Vector_007, 0);
		...
		_Vector_007.addOutputs([_TranslateObject_002]);
		_Math_008.addOutputs([_Vector_007]);
		var _Math_003 = new armory.logicnode.MathNode(this);
		_Math_003.property0 = "Multiply";
		_Math_003.property1 = "false";
		_Math_003.addInput(_MouseCoords_003, 2);
		_Math_003.addInput(new armory.logicnode.FloatNode(this, 0.0013000000035390258), 0);
		var _Vector_006 = new armory.logicnode.VectorNode(this);
		_Vector_006.addInput(_Math_003, 0);
		...
		_RotateObject_004.addInput(_Gate_007, 0);
		_RotateObject_004.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Kugellager.003"), 0);
		_RotateObject_004.addInput(_Vector_006, 0);
		_RotateObject_004.addOutputs([new armory.logicnode.NullNode(this)]);
		_Vector_006.addOutputs([_RotateObject_004]);
		_Math_003.addOutputs([_Vector_006]);
		_MouseCoords_003.addOutputs([_Math_002, _Math_008, _Math_003]);
		_PickObject_003.addInput(_MouseCoords_003, 0);
		_PickObject_003.addOutputs([_Gate_007]);
		_PickObject_003.addOutputs([new armory.logicnode.VectorNode(this, 0.0, 0.0, 0.0)]);
		_Gate_007.addInput(_PickObject_003, 0);
		_Gate_007.addOutputs([_TranslateObject_002, _RotateObject_005, _RotateObject_004]);
		_Object.addOutputs([_SetTransform_003, _Gate_007]);
		_SetTransform_003.addInput(_Object, 0);
		var _GetTransform_003 = new armory.logicnode.GetTransformNode(this);
		_GetTransform_003.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Screw_Up.003"), 0);
		...
		_Object_003.addInput(new armory.logicnode.ObjectNode(this, "KM100_Top"), 0);
		_Object_003.addOutputs([_SetTransform]);
		_SetTransform.addInput(_Object_003, 0);
		var _GetTransform = new armory.logicnode.GetTransformNode(this);
		_GetTransform.addInput(new armory.logicnode.ObjectNode(this, "Ur_KM100_Top.003"), 0);
