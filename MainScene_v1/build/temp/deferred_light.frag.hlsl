...
void frag_main()
{
    ...
    float3 _477 = fragColor.xyz * ssaotex.SampleLevel(_ssaotex_sampler, texCoord, 0.0f).x;
    fragColor = float4(_477.x, _477.y, _477.z, fragColor.w);
    ...
    float3 _522 = fragColor.xyz + ((sdirect * svisibility) * sunCol);
    fragColor = float4(_522.x, _522.y, _522.z, fragColor.w);
    fragColor.w = 1.0f;
}
