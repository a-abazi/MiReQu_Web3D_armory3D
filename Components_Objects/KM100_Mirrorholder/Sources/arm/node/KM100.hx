...
@:keep class KM100 extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Object_005.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_GetTransform_002.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_Object.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_RotateObject_005.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_RotateObject_004.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_GetTransform_003.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_Object_003.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
