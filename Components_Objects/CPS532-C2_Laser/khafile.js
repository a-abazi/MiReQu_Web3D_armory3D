...
project.addParameter('arm.Spawner_LDM56_Base');
project.addParameter("--macro keep('arm.Spawner_LDM56_Base')");
...
project.addShaders("build_CPS532-C2_Laser/compiled/Shaders/*.glsl", { noembed: false});
project.addShaders("build_CPS532-C2_Laser/compiled/Hlsl/*.glsl", { noprocessing: true, noembed: false });
project.addAssets("build_CPS532-C2_Laser/compiled/Assets/**", { notinlist: true });
project.addAssets("build_CPS532-C2_Laser/compiled/Shaders/*.arm", { notinlist: true });
