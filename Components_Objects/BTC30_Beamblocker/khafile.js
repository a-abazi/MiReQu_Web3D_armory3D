// Auto-generated
let project = new Project('BTC30_Beamblocker');
...
project.addShaders("build_BTC30_Beamblocker/compiled/Shaders/*.glsl", { noembed: false});
project.addShaders("build_BTC30_Beamblocker/compiled/Hlsl/*.glsl", { noprocessing: true, noembed: false });
project.addAssets("build_BTC30_Beamblocker/compiled/Assets/**", { notinlist: true });
project.addAssets("build_BTC30_Beamblocker/compiled/Shaders/*.arm", { notinlist: true });
