...
project.addLibrary("C:/armsdk-20.06/armory");
project.addLibrary("C:/armsdk-20.06/iron");
project.addLibrary("C:/armsdk-20.06/lib/haxebullet");
project.addAssets("C:/armsdk-20.06/lib/haxebullet/ammo/ammo.wasm.js", { notinlist: true });
project.addAssets("C:/armsdk-20.06/lib/haxebullet/ammo/ammo.wasm.wasm", { notinlist: true });
...
project.addAssets("C:/armsdk-20.06/armory/Assets/brdf.png", { notinlist: true });
project.addAssets("C:/armsdk-20.06/armory/Assets/smaa_area.png", { notinlist: true });
project.addAssets("C:/armsdk-20.06/armory/Assets/smaa_search.png", { notinlist: true });
project.addShaders("C:/armsdk-20.06/armory/Shaders/debug_draw/**");
project.addParameter('--times');
project.addLibrary("C:/armsdk-20.06/lib/zui");
project.addAssets("C:/armsdk-20.06/armory/Assets/font_default.ttf", { notinlist: false });
