...
project.addShaders("build_KM100_Mirrorholder_v2/compiled/Shaders/*.glsl", { noembed: false});
project.addShaders("build_KM100_Mirrorholder_v2/compiled/Hlsl/*.glsl", { noprocessing: true, noembed: false });
project.addAssets("build_KM100_Mirrorholder_v2/compiled/Assets/**", { notinlist: true });
project.addAssets("build_KM100_Mirrorholder_v2/compiled/Shaders/*.arm", { notinlist: true });
