...
@:keep class Genral_Object_properties_interactive extends armory.logicnode.LogicTree {
	...
	public function new() {
		super();
		name = "Genral_Object_properties_interactive";
	...
	override public function add() {
		...
		_SetProperty_003.addInput(new armory.logicnode.StringNode(this, "init"), 0);
		var _Boolean_002 = new armory.logicnode.BooleanNode(this);
		_Boolean_002.addInput(new armory.logicnode.BooleanNode(this, true), 0);
		_Boolean_002.addOutputs([_SetProperty_003]);
		_SetProperty_003.addInput(_Boolean_002, 0);
		_SetProperty_003.addOutputs([new armory.logicnode.NullNode(this)]);
		_Self_002.addOutputs([_SetProperty, _SetProperty_001, _SetProperty_002, _SetProperty_003]);
		_SetProperty.addInput(_Self_002, 0);
		_SetProperty.addInput(new armory.logicnode.StringNode(this, "movable"), 0);
		...
		_OnInit.addOutputs([_SetProperty, _SetProperty_001, _SetProperty_002, _SetProperty_003]);
